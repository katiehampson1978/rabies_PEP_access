################################################################################
#                      7.2 Run Multivar decision tree model                    #
# run ALL scenarios (discount) & save outputs to folder: countryLTs_discount
################################################################################
...
# Set number of runs
n = 500 # 1 hr per scenario - so ~8 hrs!
# n = 5
...
gavi_info <- read.csv("output/gavi_output_data_26062018.csv") # Load gavi-prepared data
